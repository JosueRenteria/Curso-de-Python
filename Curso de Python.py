#Titulo Programa: Documentacion de Python
...
#Es bueno para Ciencia de Datos o la Tecnologia.

#Para ver la version de python y entrar en el Simbolo del Sistema. >>python --version >>python
#Salir del Cmd >>exit()
